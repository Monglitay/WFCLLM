...
from wfcllm.detection.config import DETECTOR_MODE, WFCLLMDetectionConfig
...
class WFCLLMDetectionPipeline:
    """Calibrate and apply the WFCLLM final-code detector."""
