...
def mark_static_selector_diagnostic(payload: dict[str, Any]) -> dict[str, Any]:
    marked = {
        **payload,
...
def select_static_candidates(
    *,
    ...
    for sample_id in sorted(baseline_by_id):
        ...
        use_candidate = _use_static_candidate(
            policy=policy,
        ...
        selected_rows.append(_sanitized_static_row(selected))
        per_sample.append(
            {
                "id": sample_id,
    ...
    return selected_rows, mark_static_selector_diagnostic(analysis)


def _use_static_candidate(
    *,
    policy: str,
...
def _sanitized_static_row(row: dict[str, Any]) -> dict[str, Any]:
    return {
